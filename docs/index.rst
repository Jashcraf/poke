...
* *Zemax*: `zosapi by Michael Humphreys <https://github.com/x68507/zosapi>`_
* *CODE V*: `pywin32 by Mark Hammond et al, which may be installed by default <https://pypi.org/project/pywin32/>`_

Furthermore, there are some raytracer-specific quirks with using Poke and running raytraces in Jupyter/IPython notebooks, see `Using Jupyter Notebooks & Raytracer Specifics <https://poke.readthedocs.io/en/latest/notebooks/using_ipython.html>`_ for guidance on navigating them.
